...
<body>
    ...
    <div class="container">
        <div class="card mt-5">
            ...
            <div class="card-body">
                <form action="/insertdatapelanggan" method="POST">
                    @csrf
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="namapelanggan" id="namapelanggan" autocomplete="off" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="namakota" id="namakota" autocomplete="off" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="notelepon" class="col-sm-2 col-form-label">No Telepon</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="notelepon" id="notelepon" autocomplete="off" required>
                        </div>
                    </div>
                    <div>
