                ...
                <form action="{{ route('pelanggan.store') }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('kode_pelanggan') is-invalid @enderror"
                            name="kode_pelanggan" id="kode_pelanggan" value="{{ old('kode_pelanggan') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_pelanggan') is-invalid @enderror"
                            name="nama_pelanggan" id="nama_pelanggan" value="{{ old('nama_pelanggan') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_kota') is-invalid @enderror" name="nama_kota"
                            id="nama_kota" value="{{ old('nama_kota') }}">
                        @error('nama_kota')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
