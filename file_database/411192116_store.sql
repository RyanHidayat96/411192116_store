...
(1, 'KD0001', 'Velg Racing', 'barang bagus pokoknya', 15, 150000),
(2, 'KD0002', 'Velg Biasa', 'Barang good quality', 25, 100000),
(3, 'KD0003', 'Bangku Bakso', 'Apa ajalah', 15, 130000);
...
(4, '2022_12_21_032235_create_barangs_table', 1),
(5, '2022_12_21_033233_create_pelanggans_table', 1),
(6, '2022_12_21_033248_create_penjualans_table', 1);
...
CREATE TABLE `pelanggans` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `kode_pelanggan` char(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nama_pelanggan` char(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `alamat` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `nama_kota` char(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'PL0001', 'Vera Oktavian', 'Cibubur Raya', 'Jakarta', '088809823755');
...
CREATE TABLE `penjualans` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `no_penjualan` char(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'INV00001', '2022-12-21', 'PL0001', 'KD0001', 10, 30000);
...
ALTER TABLE `pelanggans`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `pelanggans_kode_pelanggan_unique` (`kode_pelanggan`);
